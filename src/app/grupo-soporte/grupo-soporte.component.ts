...
@Component({
  selector: 'app-grupo-soporte',
  templateUrl: './grupo-soporte.component.html',
  styleUrls: ['./grupo-soporte.component.css']
})
export class GrupoSoporteComponent implements OnInit {
