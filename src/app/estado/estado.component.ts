...
export class EstadoComponent implements OnInit {
  ...
  siteFinish(event){
    ...
    if(this.sitios.length <= this.endReport.length){
      this.alert.setInfo("Operación finalizada", "El cambio de estado de sitios terminó, lea el reporte generado al final del log para ver los resultados de su ejecucion", "OK");
