...
export class TecnologiaComponent implements OnInit {
  ...
  constructor(private altaServ: AltaServiceService, private automatas: AutomatasService, private http: Http) {
    ...
    this.docReference = environment.AUTO_REFERENCE + '/formatos/CAMBIO_TECNOLOGIA_TIPO.csv';
  }
  ...
  fileChargue(e) {
    ...
    fileReader.onload = (e) => {
      ...
      let validacion: string[] = this.altaServ.validarArchivoTec(this.archivo);
  ...
  showInfo(){
    this.info.setInfo('Cambio de nombre','<h4>¿Cómo usar esta página?</h4><p>Debes colocar en el fomulario de CRQ el crq que has generado o que se te proporcionó para '+
