...
export class GruposComponent implements OnInit {
  ...
  constructor(private altaServ: AltaServiceService, private automatas: AutomatasService, private http: Http) {
    ...
    this.docReference = environment.AUTO_REFERENCE + '/formatos/ASIGNACION_GRUPO.csv';
  }
  ...
  fileChargue(e) {
    ...
    fileReader.onload = (e) => {
      ...
      let validacion: string[] = this.altaServ.validarArchivoGrupo(this.archivo);
  ...
  showInfo(){
    this.info.setInfo('Grupos de soporte','<h4>¿Cómo usar esta página?</h4><p>Debes colocar en el fomulario de CRQ el crq que has generado o que se te proporcionó para '+
